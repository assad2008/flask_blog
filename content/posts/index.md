...
Summary: 左手代码，右手可乐
Title: 博客序
seo_description: 本文作者以自嘲的口吻分享了自己作为形式主义者和拖延症患者的经历，以及如何因迷恋Markdown语法而决定重新开启技术博客。文章告别WordPress时代，强调使用纯文本编辑、告别数据库、生成静态HTML的简单理念，并介绍了基于Python和Nginx的极简博客搭建方案。适合技术爱好者、博客写作者和Markdown爱好者阅读。
seo_keywords: Markdown博客, 静态博客, 技术博客, 博客搭建, Python
---
