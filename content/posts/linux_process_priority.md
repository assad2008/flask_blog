...
Authors: Django Wong
Date: 2016-04-09
Summary: 为什么要有进程优先级？这似乎不用过多的解释，毕竟自从多任务操作系统诞生以来，进程执行占用cpu的能力就是一个必须要可以人为控制的事情。因为有的进程相对重要，而有的进程则没那么重要。进程优先级起作用的方式从发明以来基本没有什么变化，无论是只有一个cpu的时代，还是多核cpu时代，都是通过控制进程占用cpu时间的长短来实现的。
Title: Linux的进程优先级
seo_description: 深入解析Linux进程优先级机制，涵盖nice值、priority值及实时进程优先级。本文详细说明进程优先级如何影响CPU资源分配，对比nice与priority概念差异，并介绍chrt、renice等命令的使用方法，帮助理解Linux内核调度策略。
seo_keywords: Linux进程优先级, nice值, 实时进程, CPU调度, chrt命令
---
...
转自：[http://liwei.life/2016/04/07/linux%E7%9A%84%E8%BF%9B%E7%A8%8B%E4%BC%98%E5%85%88%E7%BA%A7/](http://liwei.life/2016/04/07/linux%E7%9A%84%E8%BF%9B%E7%A8%8B%E4%BC%98%E5%85%88%E7%BA%A7/)